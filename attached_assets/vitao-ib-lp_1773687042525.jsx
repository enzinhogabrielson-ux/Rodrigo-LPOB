...
function TickerCard({ symbol, value, change, positive, style={} }) {
  return (
    <div style={{
...
function ProfitBadge({ value, style={} }) {
  return (
    <div style={{
...
function VideoCard({ active, name, idx }) {
      ...
      <section style={{ background: BG_MAIN, padding:"100px 40px" }}>
        <div style={{ maxWidth:900, margin:"0 auto", textAlign:"center" }}>
          ...
          <div style={{ position:"relative", minHeight:360 }}>
            ...
            {/* Arrows */}
            {[{d:"l",fn:()=>setSlide(s=>(s-1+total)%total)},{d:"r",fn:()=>setSlide(s=>(s+1)%total)}].map(({d,fn},i)=>(
              <button key={d} onClick={fn} style={{
                position:"absolute", top:"45%", [d==="l"?"left":"right"]:0,
